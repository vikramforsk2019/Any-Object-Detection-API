...
def hello(file):
    ...
    file_cfg = "yolov3_custom.cfg";
    modelConfiguration=os.path.join(os.getcwd() + Weight_FOLDER, file_cfg);
    modelWeights_file = "yolov3.weights";
    modelWeights=os.path.join(os.getcwd() + Weight_FOLDER, modelWeights_file );
